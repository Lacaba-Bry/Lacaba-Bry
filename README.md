...
> Automatically generated by [Platane's Snake](https://github.com/Platane/snk).  
> To enable it: fork the repo, create a branch named `output`, and follow [this guide](https://github.com/Platane/snk#readme).
